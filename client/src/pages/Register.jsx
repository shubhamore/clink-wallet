...
export default function Register() {
    ...
    return (<>
        ...
        {!isLoading?(<><form onSubmit={userRegister} className='flex flex-col w-[300px] max-w-full px-[25px] py-[15px] border-2 border-slate-50 rounded-lg '>
        ...
        <h1 className='my-5'>Already have an account?<span className='text-gray-300'> <Link to="/login">Login</Link></span></h1></>):(<h1 className='text-3xl text-center'>Loading...</h1>)}
